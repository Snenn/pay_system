...
<div STYLE="border-radius: 4px; background-color: #f1f1f8; width: 690px; height: 500px; margin-left: 10px; float: left; margin-top: 10px">
    <div STYLE="border-radius: 4px; background-color:#fffb7b; width: 690px; height: 30px">
        <div style="font: 'Times New Roman'; font-size: 120%; margin-left: 20px;"><spring:message code="transfers"/></div>

        <div style="margin-top: 20px">
            <div class="row" style="margin-left: 10px">
                <div class=col-md-2 ><spring:message code="IDTransfer"/></div>
                <div class=col-md-2 style="text-align: center"><spring:message code="IDSender"/></div>
                <div class=col-md-3 style="text-align: center"><spring:message code="IDRecipient"/></div>
                <div class=col-md-1 style="text-align: center"><spring:message code="amount"/></div>
